...
class ViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func animateRefreshStep2() {
        UIView.animate(withDuration: 0.40, delay: 0.0, options: UIView.AnimationOptions.curveLinear, animations: { () -> Void in
            ...
            self.labelsArray[11].transform = CGAffineTransform(scaleX: 1.5, y: 1.5)
                ...
                UIView.animate(withDuration: 0.25, delay: 0.0, options: UIView.AnimationOptions.curveLinear, animations: { () -> Void in
